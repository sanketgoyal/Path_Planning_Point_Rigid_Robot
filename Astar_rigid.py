...
def correct_start(first_node):
    ...
    if q ==1 or first_node[0] not in range(0,int(250/r) +1) or first_node[1] not in range(0,int(150/r) +1):
...
def correct_end(goal):
    ...
    if q ==1 or goal[0] not in range(0,int(250/r) +1) or goal[1] not in range(0,int(150/r) +1):
